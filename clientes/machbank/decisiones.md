...
## 2026-08-10 — Incorporación de la presentación interna de agosto

| Campo | Detalle |
|---|---|
| **Decisión** | Incorporar `Para el martes-comprimido (1).pdf` (Pres. Marketing Planificación 2026) como fuente primaria del expediente. |
| **Fundamento** | Cierra las brechas 1, 3 y 4. Sustituye inferencia de prensa por datos internos: objetivos, KPIs, tracking marcario de 3 años y roadmap. |
| **Entregable** | `02-lectura-pres-agosto-2026.md`. |
| **Efecto sobre el diagnóstico previo** | **Confirma** la hipótesis de territorio (§1.3, historial crediticio). **Supera** las estimaciones de posición competitiva: ahora hay tracking propio. **No invalida** el análisis del riesgo de nombre (§1.5), que sigue sin datos que lo confirmen o refuten. |

### Hallazgo que reordena la prioridad del trabajo

La caída en No Clientes es **monotónica durante tres años** en relevancia y en
los tres atributos foco (relevancia 45%→40%→36%). La presentación contiene la
explicación en su propia lámina: *"Los canales propios (Mail, Push, InApp) nos
permiten generar una comunicación continuada a la que NO accede un NotMACHER"*.

Esto reclasifica el problema: **no es un problema de tono ni de identidad
visual, es un problema de modelo de medios y disponibilidad mental.** El hito de
agosto ("tono y estilo renovado") ataca un síntoma.

---

## 2026-08-10 — Incorporación del Brandbook V.1

| Campo | Detalle |
|---|---|
| **Decisión** | Incorporar `BRANDBOOK_MACHBANK_ENERO_1_1.pdf` (Brand Guidelines V.1, dic-2025 / lanzado ene-2026) como fuente primaria. Cierra la brecha N4. |
| **Entregable** | `03-voz.md`. |
| **Hallazgo principal** | El hito de agosto ("tono y estilo renovado") contradice al Brandbook aprobado hace 7 meses, que establece que *"nuestra voz es constante"*. La caída del tracking es de 3 años, anterior al Brandbook: ningún tono la causó y ningún tono la revierte. |
| **Reclasificación** | El problema no es el tono. Es que el Brandbook carece de capa ejecutable (matriz Decimos/No Decimos, léxico, modulación por contexto, ejemplos). Eso explica que "estandarización de comunicaciones" siga *on going* 8 meses después. |
...
## 2026-09-15 — "Un banco pero MACH" reemplaza a "Creciste, crecimos" como frase principal

| Campo | Detalle |
|---|---|
| **Input del usuario** | *"El slogan dejará de ser 'Creciste, crecimos'. 'Un banco pero MACH' será la frase con la que llevaremos al frente lo bueno de nuestros productos."* |
| **Decisión** | "Un banco pero MACH" (territorio de VB4, ver `12-lectura-propuesta-ganadora-vb4-campana2026.md`) queda confirmado como la frase principal para comunicar la propuesta de valor / lo bueno de los productos de MACHBANK, en reemplazo de "Creciste, crecimos" (territorio de trabajo desde P15, 2026-08-10). |
| **Fundamento** | Aportado por el usuario como decisión ya tomada. No se registra fundamento de negocio adicional (quién la tomó, por qué en este momento) porque no fue comunicado — no se completa por inferencia; queda así hasta que el usuario lo amplíe. |
| **Efecto sobre P43** | ✅ **Resuelve P43** ("Creciste, crecimos" como territorio de fondo vs. reemplazo por "Un banco pero MACH") a favor del reemplazo. |
| **Efecto sobre P15** | **Superada/abandonada.** "Creciste, crecimos" deja de ser el territorio de trabajo. Mismo criterio que la reversión de P4: no se borra el razonamiento original, se marca tachada en la tabla de pendientes con nota de reemplazo. |
| **Efecto sobre P44** | **Obsoleta en su forma original.** P44 proponía ampliar P25 para incluir "Un banco pero MACH" como *cuarto candidato a evaluar*. Ya no es un candidato: es la frase decidida por el usuario. La tabla se actualiza para reflejar esto, no se elimina la fila. |
| **Efecto sobre P25** | **Responde la decisión de hecho.** P25 pedía decidir un solo tagline entre "Toca MACHBANK", "Todo, fácil." y "Banco simple que nunca te deja botado". Ninguna de las tres gana: gana una cuarta opción no contemplada en el enunciado original. Se deja explícito, sin tratarlo como cambio silencioso: la única plataforma que estaba **previamente confirmada y vigente** (no solo "en evaluación") era **"Toca MACHBANK"** — ver `00-brief.md` §1 y la entrada de este mismo log del 2026-08-10, "Corrección de estatus de taglines". "Todo, fácil." y "Banco simple que nunca te deja botado" eran propuestas iniciales sin ese estatus. Esta decisión reemplaza, entonces, a la plataforma oficial vigente, no solo a una alternativa entre pares. |
| **Efecto sobre R17/R19** | Dejan de ser riesgo de dilución por convivencia sin jerarquía declarada — ahora hay jerarquía explícita. Se marcan mitigadas en la tabla de riesgos, la entrada original no se borra. |
| **Nota para el usuario — conexión directa con P41** | Esta decisión **no resuelve P41** (relación entre la Flecha ∧ y el wordmark "MACH" que propone MEAT) — sigue bloqueando la aprobación de VB4 y sigue siendo una decisión que le corresponde tomar al usuario, no a este expediente. Pero la dirección que abre es clara y debe señalarse: si "Un banco pero MACH" es ahora la frase principal, y el wordmark "MACH" es el código visual que la acompaña de forma sistemática en toda la campaña VB4 (`12` §E), la frase y el activo visual quedarían narrando la misma idea — lo que empuja con fuerza a P41 hacia el reemplazo de la Flecha por el wordmark. Se deja registrado como información relevante para que el usuario la vea, no como una decisión tomada en su nombre. |
| **Observación fuera de alcance de esta entrada** | `00-brief.md` §1 sigue listando "La banca digital que crece contigo" como "Tagline vigente" — un tercer texto, distinto tanto de "Creciste, crecimos" como de "Un banco pero MACH" y de "Toca MACHBANK". No se corrige aquí porque no fue parte de lo comunicado por el usuario en esta decisión; queda como inconsistencia a revisar aparte. |

---

## 2026-09-16 — P41 resuelta: convivencia gobernada por etapa de funnel entre wordmark y Flecha

| Campo | Detalle |
|---|---|
| **Input del usuario** | *"El wordmark será la propuesta de valor a nivel de awareness. La idea es poder profundizar en los productos y ahí la flecha será preponderante. No son excluyentes. Parte de la solicitud era encontrar un kit de assets y usarlo consistentemente."* |
| **Decisión** | El wordmark "MACH" y la Flecha (∧) conviven, gobernados por etapa de funnel: **wordmark → nivel de awareness / comunicación de la propuesta de valor**; **Flecha → preponderante en la profundización de producto** (consideración/conversión, piezas donde se explica el producto específico). Explícitamente no son excluyentes. |
| **Efecto sobre P41** | ✅ **Resuelve P41.** Cierra la pregunta abierta desde `11-lectura-propuesta-meat-campana2026.md` §D.1 (reemplazo, convivencia o capa táctica) y agravada en `12-lectura-propuesta-ganadora-vb4-campana2026.md` §E. La opción elegida es una variante de (b) convivencia — ahora con la regla de jerarquía explícita que `11` §D.1 señalaba como condición faltante para que (b) fuera viable ("falta mostrar cómo, porque no coexisten en ninguna pieza vista"). |
| **Reemplaza a** | La hipótesis de "capa táctica" (opción c) que había quedado como propuesta abierta en `11` §D.1 y reiterada en `12` §E — una convivencia acotada a la campaña puntual VB4, con la Flecha reservada como activo de largo plazo fuera de esa campaña, sujeta a revisión por métricas. Esta decisión del usuario es distinta y más permanente: no es una capa táctica con vigencia limitada a VB4, es una regla de arquitectura de assets por etapa de funnel, aplicable en adelante y no solo a esta campaña. Mismo criterio que P4 y P15: no se borra el razonamiento anterior, se deja visible con esta nota de reemplazo. |
| **Relación con P14** | Avanza parcialmente P14 (proteger e intensificar la Flecha) en el tramo de profundización de producto, donde ahora es preponderante por decisión explícita del usuario. P14 en su alcance completo — protección/intensificación across todo el sistema visual, incluido el nivel de awareness donde ahora manda el wordmark — sigue sin validar como decisión cerrada. No se marca P14 como resuelta. |
| **Requerimiento nuevo** | El usuario aclara que parte del encargo original era llegar a un **kit de assets** (wordmark + Flecha + reglas de uso por etapa de funnel) de uso consistente. Se registra como **P46**, conectado con P36 (formato de playbook por producto) y P39 (revisión de piezas contra estándar de marca) — los mecanismos ya definidos en el expediente donde ese kit se aplicaría. Alcance (formatos, piezas, responsable de producción) queda abierto — no se completa por inferencia. |
| **Entregable actualizado** | `12-lectura-propuesta-ganadora-vb4-campana2026.md` §E recibe nota breve señalando que P41 fue resuelta por el usuario el 2026-09-16, sin reescribir el análisis original (que documenta por qué VB4, tal como llegó, agravaba la tensión sin resolverla). |
...
| **P9** | **Revisar "Tocó X, Toca Machbank"** — falla el test del robo de Neumeier y la plataforma "Simplicidad resolutiva" se apoya en el atributo relativamente más débil. | `02` §C.4 | ⏳ Sin validar |
| **P10** | **NO renovar el tono en agosto.** Reencuadrar el hito a "capa ejecutable de la voz": matriz Decimos/No Decimos, léxico, modulación por contexto, ejemplos antes/después. | `03` §B.1, §B.3, §D | ⏳ Sin validar — **la más urgente** |
| **P11** | **Corregir el sistema de arquetipos:** Héroe 55% + Cuidador 30% + Explorador 15%, en reemplazo de Explorador + Héroe. Fundamento: ninguno de los dos actuales entrega "va a funcionar" (11% vs 22% del líder), y nadie domicilia su sueldo en un Explorador. | `03` §B.2 | ⏳ Sin validar |
...
| **P14** | **Proteger e intensificar la Flecha (∧) y el morado #6200EE** como activos distintivos. No tocar el sistema visual. | `03` §C | ⏳ Sin validar en su alcance completo — **parcialmente avanzada (2026-09-16)** por la resolución de P41: la Flecha será preponderante en piezas de profundización de producto. Falta validar el resto del sistema, incl. el nivel awareness. Ver entrada 2026-09-16. |
...
| **P15** | ~~**Desarrollar "Creciste, crecimos"** como semilla de territorio — única línea del Brandbook con idea propia, compatible con el white space de crédito.~~ | `03` §B.4 | ❌ **SUPERADA (2026-09-15).** El usuario confirmó "Un banco pero MACH" como frase principal, en reemplazo directo. Ver entrada 2026-09-15 y P43. |
...
| **P25** | **Decidir un solo tagline** entre "Toca MACHBANK", "Todo, fácil." y "Somos un banco simple que nunca te deja botado" — no pueden convivir los tres sin diluirse. | `07` §E | ✅ **Resuelta de hecho (2026-09-15)** a favor de "Un banco pero MACH" — cuarta opción, fuera del enunciado original de P25. Nota importante: reemplaza en los hechos a "Toca MACHBANK", que era la única plataforma **previamente confirmada y vigente** (no solo candidata) — ver `00-brief.md` §1 y entrada 2026-08-10 "Corrección de estatus de taglines". No es un cambio silencioso entre alternativas equivalentes. Ver entrada 2026-09-15. |
...
| **P41** | ~~**Decidir explícitamente la relación entre la Flecha (∧) y el wordmark "MACH"** que propone MEAT antes de aprobar VB3 — reemplazo, convivencia o capa táctica. No dejarlo implícito.~~ | `11` §D.1 · agravada en `12` §E (VB4 usa el wordmark de forma sistemática en toda la campaña) | ✅ **Resuelta (2026-09-16).** El usuario decidió convivencia gobernada por etapa de funnel: wordmark "MACH" = nivel de awareness / propuesta de valor; Flecha (∧) = preponderante en la profundización de producto. No son excluyentes. Reemplaza la hipótesis de "capa táctica" (opción c) que había quedado abierta en `11`/`12`. Origina P46 (kit de assets). Ver entrada 2026-09-16. |
...
|---|---|---|---|
| R1 | Erosión del asset verbal "MACH" por el sufijo "BANK". Impacto silencioso sobre CAC. | 🔴 Alta | P5 |
| R2 | La cohorte captada por promoción puede tener retención estructuralmente peor. | 🟠 Media | Medir por separado (pregunta N3). |
| R3 | El claim "primer banco 100% digital" depende de la situación regulatoria de Tenpo, sin verificar. | 🟠 Media | Verificar en registro CMF antes de usar en campaña. |
...
| **R17** | ~~**Tres taglines en circulación sin jerarquía declarada** ("Toca MACHBANK", "Todo, fácil.", "Banco simple que nunca te deja botado"). Riesgo de dilución si conviven sin decisión.~~ | ✅ **Mitigado (2026-09-15)** | Jerarquía declarada: el usuario confirmó "Un banco pero MACH" como frase principal, en reemplazo de las opciones previas. Ver entrada 2026-09-15 y P25. |
...
| **R19** | ~~**"Un banco pero MACH" (VB4) se instala como cuarto tagline candidato en circulación**, con volumen de producción creativa real detrás — agrava R17 y hace más costoso revertir después si P25 se resuelve por otro camino.~~ | ✅ **Mitigado (2026-09-15)** | Deja de ser un candidato en competencia: el usuario lo confirmó como frase principal, resolviendo P25/P43 de hecho. Ver entrada 2026-09-15. |
